...
# vit-large
export IMAGENET_DIR="/home/rtcalumby/adam/luciano/LifeCLEFPlant2022/web"
export name="MAE_PC2022_web_pretrain_ViT_L"
export resume_epoch=540
#export name="MAE_PlantCLEF2022_trust_train_pretrain_vit_large"
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 python -m torch.distributed.launch --nproc_per_node=6 main_pretrain.py \
  --accum_iter 4 \
  --batch_size 128 \
